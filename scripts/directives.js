...
angular.module('LydiaSzalon').directive('myCostStr', function() {
  return {
	restrict: 'A',
...
angular.module('LydiaSzalon').filter('accentsfilter',function(){
...
angular.module('LydiaSzalon').directive('myImageSizer', function($interval) {
  return {
	restrict: 'A',
    link: function($scope,elem, attr) {
	    let lastSize = 0;
...
angular.module('LydiaSzalon').directive('myImageSizerv2', function($interval) {
  return {
	restrict: 'A',
    link: function($scope,elem, attr) {
	    let lastSize = 0;
...
angular.module('LydiaSzalon').directive('myNewsletter', function($http) {
    return {
        restrict: 'A',
